...
export default function Statement() {
  return (
    ...
    >
      <motion.p
        className="font-display text-3xl md:text-5xl lg:text-6xl font-light text-(--ink) leading-[1.3] max-w-4xl"
      ...
      <motion.p
        ...
        className="font-body text-[11px] tracking-[0.25em] uppercase text-(--ink-muted)"
